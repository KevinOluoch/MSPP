...
# Create Tmin CSV
Tmin <- agMERRAnc4ToCSV::xtrctagMERRAnc4(nc4Files = Tmin.nc4files,
                                         shpdf = shpfle, name_1 = "Name.1",
                                         name_2 = "Name.2")

# Create Tmax CSV
Tmax <- agMERRAnc4ToCSV::xtrctagMERRAnc4(nc4Files = Tmax.nc4files,
                                         shpdf = shpfle, name_1 = "Name.1",
                                         name_2 = "Name.2")

# Create Tavg CSV
Tavg <- agMERRAnc4ToCSV::xtrctagMERRAnc4(nc4Files = Tavg.nc4files,
                                         shpdf = shpfle, name_1 = "Name.1",
                                         name_2 = "Name.2")
```
...
Steps for updating/connecting an Excel sheets (Tmin. Tmax and Tavg) to the source CSV generated from the steps above. 
NB: The Sheets are protected wit "TAMASA" as the password
